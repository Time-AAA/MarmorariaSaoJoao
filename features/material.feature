Feature: CRUD Material
    ...
    Scenario: remover material com sucesso
        ...
        And existe um material com o nome "Marmore Resinado", valor "20.00", tipo "Marmore", cor "Rosa" e origem "Nacional"
    ...
    Scenario: editar nome do material com sucesso
        ...
        Then Eu vejo uma mensagem informando que o material com o nome "Marmore Bruto" foi editado com sucesso

...
When("Eu seleciono a opcao de remover o material com nome {string}") do |string|
  pending # Write code here that turns the phrase above into concrete actions
end

Then("Eu vejo uma mensagem informando que o material com o nome {string} foi removido") do |string|
  pending # Write code here that turns the phrase above into concrete actions
end
...
When("Eu seleciono a opcao de editar o material com nome {string}") do |string|
  pending # Write code here that turns the phrase above into concrete actions
end

When("Eu edito o nome do material {string} para {string}") do |string, string2|
  pending # Write code here that turns the phrase above into concrete actions
end

Then("Eu vejo uma mensagem informando que o material com o nome {string} foi editado com sucesso") do |string|
  pending # Write code here that turns the phrase above into concrete actions
end
